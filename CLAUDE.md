...
2. Analyze the review feedback from Codex, judge if it makes sense, and identify what needs to be changed
...
5. If Codex still has feedback, continue iterating
